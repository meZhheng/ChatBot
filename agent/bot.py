from agent.tools import InternetSearchTool, VirtualSearchTool, get_current_time, get_weight, get_distance
from langchain.agents import create_agent
from langchain_openai import ChatOpenAI

from agent.middleware import *
from agent.utils.config_handler import env_override, get_env, load_agent_config, load_prompts_config
...
agent = create_agent(
    model=ChatOpenAI(
        model=env_override(qwen_config.get("chat_model", "qwen3.6-flash"), "QWEN_CHAT_MODEL"),
